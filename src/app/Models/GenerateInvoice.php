...
class GenerateInvoice extends Model
{
    ...
    /*** [PART 1] INVOICR DATA ***/
    // (A) FILE PATHS
    private $pathI = __DIR__ . DIRECTORY_SEPARATOR . "invlib" . DIRECTORY_SEPARATOR;
    private $pathV = __DIR__ . DIRECTORY_SEPARATOR . "invlib" . DIRECTORY_SEPARATOR . "vendor" . DIRECTORY_SEPARATOR;
    private $pathD = __DIR__ . DIRECTORY_SEPARATOR . "invlib" . DIRECTORY_SEPARATOR . "DOCX" . DIRECTORY_SEPARATOR;
    private $pathH = __DIR__ . DIRECTORY_SEPARATOR . "invlib" . DIRECTORY_SEPARATOR . "HTML" . DIRECTORY_SEPARATOR;
